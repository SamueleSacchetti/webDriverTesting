...
def select_shoe_size(driver, shoe_size, shoe_type, skip_size_selection):
    ...
    wait_until_visible(driver, class_name="size-grid-button", duration=20)
    ...
    if skip_size_selection:
        ...
        size_text = driver.find_element(By.XPATH, "//li[@data-qa='size-available']/button").text
        ...
        if re.search("[a-zA-Z]", size_text):
            ...
            if special_shoe_type:
                driver.find_element(By.XPATH, "//li[@data-qa='size-available']").find_element(By.XPATH, 
...
if __name__ == "__main__":
    ...
    if args.driver_type == "chrome":
        ...
        #if you dont want to see chrome interface
